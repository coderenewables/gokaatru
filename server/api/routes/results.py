...
def get_plot(
    ...
    plot_dispatch: dict[str, Callable[[], dict]] = {
        ...
        "sensor_distribution": lambda: _plot_sensor_distribution(state, body.sensor_name),
        "diurnal_boxplot": lambda: _plot_diurnal_boxplot(state, body.sensor_name),
        ...
        "sensor_residuals": lambda: _plot_sensor_residuals(state, body.sensor_a, body.sensor_b),
        "mast_shadow": lambda: _plot_mast_shadow(state, body.sensor_a, body.sensor_b, body.direction_sensor),
        "qc_flags": lambda: _plot_qc_flags(state),
        ...
        "shear_timeseries": lambda: _plot_shear_timeseries(state),
        "era5_scatter": lambda: _plot_era5_scatter(state),
        "shear_alpha": lambda: _plot_shear_alpha(state, body.sensor_names),
        "wind_veer": lambda: _plot_wind_veer(state, body.sensor_names),
        ...
        "turbulence_windrose": lambda: _plot_turbulence_windrose(
            state,
            body.speed_sensor or body.sensor_name,
            body.sensor_b,
            body.direction_sensor,
